...
if "%PATH_GCCARM%"=="" (
  set OBJCOPY="D:\Programas\Simplicity studio\developer\toolchains\gnu_arm\7.2_2017q4\bin\arm-none-eabi-objcopy.exe"
) else (
...
if "%PATH_SCMD%"=="" (
  set COMMANDER="D:\Programas\Simplicity studio\developer\adapter_packs\commander\commander.exe"
) else (
